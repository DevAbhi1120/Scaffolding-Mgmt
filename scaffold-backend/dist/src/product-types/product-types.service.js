...
const product_type_entity_1 = require("../database/entities/product-type.entity");
...
let ProductTypesService = class ProductTypesService {
    ...
    async uploadImage(file) {
        ...
        if (hasAws) {
            ...
            const uploadDir = (0, path_1.join)(process.cwd(), 'uploads', 'product-types');
    ...
    async create(dto, file) {
        ...
        if (existing) {
            throw new common_1.ConflictException('Product type with this name already exists');
        }

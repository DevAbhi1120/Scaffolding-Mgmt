...
__decorate([
    (0, typeorm_1.Column)({ name: 'orderId', type: 'char', length: 36, nullable: true }),
...
__decorate([
    (0, typeorm_1.Column)({ name: 'submittedBy', type: 'char', length: 36, nullable: true }),
    __metadata("design:type", Object)
], SafetyChecklist.prototype, "submittedBy", void 0);
__decorate([
    (0, typeorm_1.Column)({ name: 'checklistData', type: 'json' }),
    __metadata("design:type", Object)
], SafetyChecklist.prototype, "checklistData", void 0);
__decorate([
    (0, typeorm_1.Column)({ name: 'dateOfCheck', type: 'date' }),
...
__decorate([
    (0, typeorm_1.Column)({ name: 'preserved', type: 'boolean', default: true }),
...
//# sourceMappingURL=safety-checklist.entity.js.map